...
public class MyRedisConfig {
  ...
  private LettucePoolingClientConfiguration getLettucePoolingClientConfiguration(RedisProperties redisProperties) {
    final LettucePoolingClientConfiguration lettucePoolingClientConfiguration = LettucePoolingClientConfiguration.builder().commandTimeout(Duration.ofMillis(redisProperties.getConnectionTimeout()))
